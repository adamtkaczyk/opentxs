...
class StorageMock final : public opentxs::api::session::internal::Storage
{
public:
    MOCK_METHOD(
    ...
    MOCK_METHOD(
        opentxs::UnitType,
        BlockchainSubaccountAccountType,
        (const opentxs::identifier::Nym&, const opentxs::Identifier&),
        (const, final));
    MOCK_METHOD(
    ...
    auto Load(
        ...
        const bool checking = false) const -> bool final
    {
        return LoadHelper(nymID, channelID, output, checking);
    }
    ...
    auto Load(
        ...
        const bool checking = false) const -> bool final
    {
        return LoadHelper(id, contact, checking);
    }
    ...
    auto Load(
        ...
        const bool checking = false) const -> bool final
    {
        return LoadHelper(id, contact, alias, checking);
    }
    ...
    auto Load(
        ...
        const bool checking = false) const -> bool final
    {
        return LoadHelper(nym, id, context, checking);
    }
    ...
    auto Load(
        ...
        const bool checking = false) const -> bool final
    {
        return LoadHelper(id, cred, checking);
    }

    MOCK_METHOD(
        bool,
        LoadHelper,
        (const opentxs::identifier::Nym&, opentxs::proto::Nym&, const bool),
        (const));
    ...
    auto Load(
        ...
        const bool checking = false) const -> bool final
    {
        return LoadHelper(id, nym, checking);
    }
    ...
    auto Load(
        ...
        const bool checking = false) const -> bool final
    {
        return LoadHelper(id, nym, alias, checking);
        ;
    }
    ...
    MOCK_METHOD(
        ...
        (const opentxs::UnallocatedCString&,
         const opentxs::UnallocatedCString&,
         const opentxs::otx::client::StorageBox,
         opentxs::UnallocatedCString&,
         opentxs::UnallocatedCString&,
         const bool),
        (const));
    ...
    virtual auto Load(
        const opentxs::UnallocatedCString& nymID,
        const opentxs::UnallocatedCString& id,
        const opentxs::otx::client::StorageBox box,
        opentxs::UnallocatedCString& output,
        opentxs::UnallocatedCString& alias,
        const bool checking = false) const -> bool final
    {
    ...
    MOCK_METHOD(void, InitBackup, (), (final));

    MOCK_METHOD(
        void,
        InitEncryptedBackup,
        (opentxs::crypto::key::Symmetric&),
        (final));
